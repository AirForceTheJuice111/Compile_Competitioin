<ScheduleProgram program_last_label_num="104" program_last_temp_num="103" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="104" last_temp_num="104" instruction_count="12">
