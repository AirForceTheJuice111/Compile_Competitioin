...
tree::Program *generate_a_testIR(Temp_map *tm) {
    ...
    Patch_list *t_1_2_true_list = new Patch_list();
    t_1_2_true_list->add_patch(label_1_2_true);
    Patch_list *t_1_2_false_list = new Patch_list();
    t_1_2_false_list->add_patch(label_1_2_false);
    ...
    Patch_list *t_2_1_true_list = new Patch_list();
    t_2_1_true_list->add_patch(label_2_1_true);
    Patch_list *t_2_1_false_list = new Patch_list();
    t_2_1_false_list->add_patch(label_2_1_false);
    ...
    Patch_list *t_x_3_4_true_list = new Patch_list();
    t_x_3_4_true_list->add_patch(label_x_3_4_true);
    Patch_list *t_x_3_4_false_list = new Patch_list();
    t_x_3_4_false_list->add_patch(label_x_3_4_false);
